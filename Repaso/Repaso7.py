...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget.setGeometry(QRect(260, 110, 160, 80))
        ...
        self.formLayout.setWidget(1, QFormLayout.ItemRole.LabelRole, self.spinBox)

        self.doubleSpinBox = QDoubleSpinBox(self.formLayoutWidget)
        self.doubleSpinBox.setObjectName(u"doubleSpinBox")

        self.formLayout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.doubleSpinBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setText(QCoreApplication.translate("MainWindow", u"Texto", None))
    # retranslateUi
